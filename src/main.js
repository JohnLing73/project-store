...
import { faTruck, faExchangeAlt, faPaperPlane, faStar, faUserCircle } from '@fortawesome/free-solid-svg-icons';
import { faCreditCard, faCopyright } from '@fortawesome/free-regular-svg-icons';
import { faTwitter, faFacebook, faInstagram } from '@fortawesome/free-brands-svg-icons';
import { FontAwesomeIcon } from '@fortawesome/vue-fontawesome'

//Using Other Packages
library.add(faTruck, faExchangeAlt, faPaperPlane, faCreditCard, faInstagram, faTwitter, faFacebook, faCopyright, faStar, faUserCircle);
